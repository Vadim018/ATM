...
namespace ATM //
{
    public partial class AdminForm_8_ : Form
    {
        ...
        string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Documents\Курсовий проєкт 2024\ATM\Database2.mdf;Integrated Security=True";
        private bool isView1Shown = true;

        public AdminForm_8_()
        {
            InitializeComponent();
            pictureBox1.Image = Image.FromFile("view2.png");
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (isView1Shown)
            {
                pictureBox1.Image = Image.FromFile("view1.png");
